    ...
    <div class="container pt-3">
        <div class="row mb-3">
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card p-3 mb-3">
                    <h4 class v-if="student.isVerified!=null">Status : {{ student.isVerified }}</h4>
                    <h4 class v-else>Status : Belum Terverifikasi</h4>
                </div>
                <div class="card p-3 cardijazah">
                    ...
                    <p class="textijazah textttl">{{ student.place_of_birth }}, {{ student.date_of_birth }}</p>
